...
//        1-2 ways to find text: "Test Text 1"
        ...
        assertEquals(text1, driver.findElement(By.xpath("//div[@id='test1']/p[@class='test']")).getText());

//        1-2 ways to find text: "Test Text 2"
        String text2 = "Test Text 2";
        assertEquals(text2, driver.findElement(By.xpath("//div[@id='test1']/p[@class='twoTest']")).getText());
        assertEquals(text2, driver.findElement(By.xpath("//*[@class=\"twoTest\"]")).getText());
        assertEquals(text2, driver.findElement(By.xpath("//*[@id='test1']/p[2]")).getText());

//        1-2 ways to find text: "Test Text 3"
        String text3 = "Test Text 3";
        assertEquals(text3, driver.findElement(By.xpath("//*[@id='test3']/p[1]")).getText());

//        1-2 ways to find text: "Test Text 4"
        String text4 = "Test Text 4";
        assertEquals(text4, driver.findElement(By.xpath("//*[@id='test3']/p[2]")).getText());
        assertEquals(text4, driver.findElement(By.xpath("//p[@class='test' and contains(text(),'4')]")).getText());

//        1-2 ways to find text: "Test Text 5"
        String text5 = "Test Text 5";
        assertEquals(text5, driver.findElement(By.xpath("//*[@id='test2']/p[1]")).getText());
        assertEquals(text5, driver.findElement(By.xpath("//*[@class='Test']")).getText());
